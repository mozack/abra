...
//		int i = 2 >> 2;
		...
		*/
		...
		System.err.println(s1.getSequenceAsString());
		System.err.println(s2.getSequenceAsString());
		System.err.println(s3.getSequenceAsString());
		System.err.println(s4.getSequenceAsString());
		System.err.println(s5.getSequenceAsString());

		System.err.println(s1.equals(s2));
		System.err.println(s2.equals(s1));
		System.err.println(s1.equals(s3));
		System.err.println(s3.equals(s1));
		System.err.println(s3.equals(s4));
		System.err.println(s3.equals(s5));
		System.err.println(s5.equals(s5));


		System.err.println(s1.getFirstCharacter());
		System.err.println(s5.getFirstCharacter());
	}
}
